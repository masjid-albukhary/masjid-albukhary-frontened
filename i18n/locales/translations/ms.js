export default {
    ...
    sign_up: {
        title: "Borang Pendaftaran Admin",
        label: {
            username: "Nama Pengguna",
    ...
    admin_sidebar: {
        ...
        about_content_form: "Pengurusan Kandungan Mengenai",
    ...
    activity_form: {
        ...
        label: {
            title_en: "Tajuk Aktiviti (Bahasa Inggeris)",
            title_my: "Tajuk Aktiviti (Bahasa Melayu)",
            description_en: "Deskripsi (Bahasa Inggeris)",
            description_my: "Deskripsi (Bahasa Melayu)",
            summary_content_en: "Ringkasan (English)",
            summary_content_my: "Ringkasan (Malay)",
            activity_date: "Tarikh Aktiviti",
            time: "Masa (Mula - Tamat)",
        ...
        placeholder: {
            ...
            description_en: "Masukkan deskripsi aktiviti dalam Bahasa Inggeris",
            description_my: "Masukkan deskripsi aktiviti dalam Bahasa Melayu",
            summary_content_en: "Masukkan ringkasan dalam bahasa Inggeris English",
            summary_content_my: "Masukkan ringkasan dalam bahasa Inggeris Bahasa Melayu",
            activity_date: "Masukkan tarikh aktiviti",
            time: "Contoh: 8:00 AM - 10:00 AM",
        ...
        options: {
            ...
            quran_class: "Kelas Al-Quran",
            community_event: "Program Komuniti",
            fundraising: "Derma",
            volunteer: "Aktiviti Sukarelawan",
            others: "Lain-lain",
            yes: "Ya",
            no: "Tidak",
        },
