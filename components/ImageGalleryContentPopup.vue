...
const props = defineProps<{
  ...
  selectedImageGalleryContent: ImageGalleryContent | null;
}>();
const emit = defineEmits([
  'hideImageGalleryContentPopup',
  'submitImageGalleryContentChanges',
  'removeImageGalleryContent'
]);
const formData = reactive<ImageGalleryContent>({
  id: 0,
  name_field: '',
  alert_field: '',
  gallery_image: '',
...
const handleSave = () => {
  ...
  if (imageFile.value) {
    updatedContent.gallery_image = imageFile.value;
  }

  emit('submitImageGalleryContentChanges', updatedContent);
};

const handleDelete = () => {
  emit('removeImageGalleryContent');
};

const closePopup = () => {
  emit('hideImageGalleryContentPopup');
};
</script>
  ...
  <div v-if="isPopupVisible" class="popup-overlay">
    <div class="popup-container">
      ...
      <div class="popup-header">
        <h2>{{t('admin.popup.image_gallery_title')}}</h2>
